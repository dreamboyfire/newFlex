...
export class UserListComponent implements OnInit {
  ...
  displayedColumns = ['telOne', 'telTwo', 'sex', 'name', 'addr', 'zipCode', 'city', 'email', 'registerDate', 'modifyDate', 'purchaseHistory', 'operation'];
...
export class SaveUsersDialog implements OnInit{
  ...
  constructor(
    ...
    ngOnInit() {
      ...
      if (this.data) {
        this.form.setValue({
          telOne: this.data.telOne,
          telTwo: this.data.telTwo,
          sex: this.data.sex,
          name: this.data.name,
          addr: this.data.addr,
